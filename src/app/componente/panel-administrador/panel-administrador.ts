  ...
  export class PanelAdministrador implements OnInit {
    ...
    mostrarTablaMembresiasSocio = false;
  socioMembresiaSeleccionado: any = null;
  membresiasDelSocio: any[] = [];
  cargandoMembresiasSocio = false;
  ...
  if (seccion !== 'socios') {
    this.mostrarTablaMembresiasSocio = false;
    this.socioMembresiaSeleccionado = null;
    this.membresiasDelSocio = [];
    this.cargandoMembresiasSocio = false;
  }
 ...
 verMembresiasSocio(socio: any) {
  const idSocioSeleccionado = Number(socio.id_socio);

  this.socioMembresiaSeleccionado = socio;
  this.membresiasDelSocio = [];
  this.cargandoMembresiasSocio = true;
  this.mostrarTablaMembresiasSocio = true;

  this.cdr.detectChanges();

  this.apiService.getMembresias().subscribe({
    next: (data: any) => {
      this.membresiasDelSocio = data.filter((membresia: any) =>
        Number(membresia.id_socio) === idSocioSeleccionado
      );
    ...
    error: (error: any) => {
      ...
      alert('No se pudieron cargar las membresías del socio.');
    }
  });
}

  cerrarTablaMembresiasSocio() {
  this.mostrarTablaMembresiasSocio = false;
  this.socioMembresiaSeleccionado = null;
  this.membresiasDelSocio = [];
  this.cargandoMembresiasSocio = false;
